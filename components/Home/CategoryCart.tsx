...
const CategoryCart: React.FC<CategoryCartData> = ({
  ...
  return (
    <div className="flex flex-col w-[47%] lg:w-[30%] bg-white rounded-xl shadow-md p-4 gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Progress progress={Math.round(percentage)} color="green" size="sm" labelProgress progressLabelPosition='outside' labelText textLabel='Expenses %' textLabelPosition='outside'/>
      </div>
    </div>
  );
};
